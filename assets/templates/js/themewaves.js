var waves_script_data = {"menu_padding":"33","menu_wid_margin":"30","blog_art_min_width":"230","pageloader":"0","header_height":"80"};
...
//            }
	...
	$('.mobile-menu-icon').click(function(){
		$('span',this).eq(0).toggleClass('x_icon_1');
		$('span',this).eq(1).toggleClass('x_icon_2');
		$('span',this).eq(2).toggleClass('x_icon_3');
	});
...
//            jQuery('#mobile-menu li').css('width', '100%').css('width', '');
    ...
    jQuery('#mobile-menu ul.sub-menu').each(function() {
		...
		$parentMenu.addClass('has-children').prepend('<div class="action-expand"><span class="opened" style="color:#F00">▽</span><span class="closed" style="">◀</span></div>');
