			...
			<section class="panel">
				...
				<div class="panel-body">
					<div class="form-horizontal tasi-form">						 
						...
						<div class="form-group">
							<label class="col-sm-2 col-sm-2 control-label">連結</label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								...
								<?php if (isset($news->img) && "" != $news->img): ?>
									<img style="max-width:512px" src="<?php echo site_url()."assets/".$news->img; ?>" />
								<?php endif ?>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								...
								<?php if (isset($news->file) && "" != $news->file): ?>
									<a target="_BLANK" href="<?php echo site_url()."assets/".$news->file; ?>">檔案</a>
								<?php endif ?>
								<input type="hidden" value="<?php echo $news->file; ?>" name="exist_file" />	
							</div>
						</div>		
						<div class="form-group">
							<div class="col-sm-12" style="text-align:center">
								<input type="hidden" value="<?php echo $news->type ?>" name="type" />
