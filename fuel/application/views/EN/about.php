    ...
    <div id="page" style="margin:0 auto;">
      <div id="" class="row-container dark row-container light" style="background-color: #FFF;">
        <div class="waves-container container">
          ...
          <div class="row">
            <div class="tw-element waves-heading center col-md-12" style="" >
              <div class="heading-container">
                <h3 class="heading-title">About Apex</h3>
              </div>
            </div>
          </div>
		  <?php echo fuel_block('about_EN'); ?>
          <!-- <div class="row">
            <div class="tw-element  col-md-12" style="" >
              <div class="tw-service-box left-service style_5 no-titleline" style="">
                <div class="tw-service-content desc_unstyle" style="margin-right:79px;">
                  <p style="color:#333;">At APEX we are passionate about sleep apnea therapy. We know the difference it makes to millions of people around the world many of who sleep with our products every night.   We also believe CPAP should be simple and affordable. The products we develop always have these goals in mind and is why APEX has become one of the most popular and respected brands in the world of sleep medicine. <br/><br/>
                  
                  Over the past fifteen years our ranges of machines and masks have been regarded as some of the highest quality available.<br/>
                    If you like simple solutions, easy to use products and don't see why you should overpay for CPAP it's time to take a good look at APEX.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="row">
            <div class="tw-element carousel-container col-md-12" style=" text-align:right;" >
              <h3 style="color:#333;">APEX MEDICAL USA CORP.</h3>
              <p style="color:#333;">615 N. Berry St. Suite D, Brea,<br/>
              CA 92821, USA<br/>
              T: +1 714 671 3818<br/>
              F: +1 714 671 9040<br/>
              sales.usa@apexmedicalcorp.com</p>
            </div>
          </div> -->
          <div class="row">
